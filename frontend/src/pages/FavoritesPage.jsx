      ...
      <section className="shell-panel mesh-surface overflow-hidden p-6 sm:p-8">
        <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-4xl leading-tight text-ink sm:text-5xl">즐겨찾기(참조 출처)</h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
              질문 중에 별표한 판례, 심판례, 법령, 내부 참고자료를 한곳에서 다시 보고 원문으로 바로 이동할 수 있습니다.
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-[24px] border border-white/70 bg-white/80 px-5 py-4 shadow-panel">
              <div className="text-xs font-semibold uppercase tracking-[0.24em] text-emerald-700/80">내부자료</div>
      ...
      <section className="shell-panel p-6 sm:p-8">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="rounded-full bg-amber-50 px-4 py-2 text-sm font-semibold text-amber-700">
            {favoritesLoading ? '불러오는 중...' : `${favorites.length}건 저장됨`}
          </div>
        </div>
